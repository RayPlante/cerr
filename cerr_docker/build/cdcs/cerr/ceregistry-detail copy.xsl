...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<xsl:variable name="eventStartDate"
			select="//rsm:Resource/rsm:content/rsm:satrtDate/*"/>
		<xsl:variable name="eventEndDate"
			select="//rsm:Resource/rsm:content/rsm:endDate/*"/>
		<xsl:variable name="eventOnline"
			select="//rsm:Resource/rsm:content/rsm:eventOnline/*"/>
		<xsl:variable name="eventVenue"
			select="//rsm:Resource/rsm:content/rsm:venue/*"/>
