...
INSTALLED_APPS = (
    ...
    # /!\ Should always be before core_explore_common_app
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # added to add custom variables for templates
                "nmrr_home.context_processor.domain_context_processor",
...
if ENABLE_ALLAUTH:  # noqa: F405 (core setting)
    ...
    if ENABLE_SAML2_SSO_AUTH:  # noqa: F405 (core setting)
        ...
        if "allauth.socialaccount.providers.saml" not in INSTALLED_APPS:
            INSTALLED_APPS = INSTALLED_APPS + ("allauth.socialaccount.providers.saml",)
